...
export function applySettingsToTheme(
  ...
  // Fallback to 'default' if primaryColor is not found in presets
  const selectedPrimaryColor = primaryColorPresets[primaryColor] || primaryColorPresets.default;

  const primaryColorPalette = {
    ...selectedPrimaryColor,
    mainChannel: hexToRgbChannel(selectedPrimaryColor.main),
  };
