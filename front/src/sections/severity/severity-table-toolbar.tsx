import type { ISeverityTableFilters } from 'src/types/severity';
...
function SeverityTableToolbarComponent({ filters, onFilters, statusOptions }: Props) {
  ...
  return (
    ...
    >
      <TextField
        ...
        placeholder={t('dashboard.severity.search.placeholder')}
        InputProps={{
          startAdornment: (
...
export const SeverityTableToolbar = memo(SeverityTableToolbarComponent);
