...
function CategoryTableToolbarComponent({ filters, onFilters, statusOptions }: Props) {
  ...
  return (
    ...
    >
      <TextField
        ...
        placeholder={t('dashboard.category.searchCategories')}
        InputProps={{
          startAdornment: (
...
export const CategoryTableToolbar = memo(CategoryTableToolbarComponent);
