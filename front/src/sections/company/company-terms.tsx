...
export function CompanyTermsPage() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const [companyData, contentData] = await Promise.all([
          ...
          getCompanyContent(slug, 'terms-and-condition'),
        ]);
        setCompany(companyData);
        setContent(contentData);
      } catch (error) {
        console.error('[CompanyTerms] Error fetching data:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  const pageTitle = content?.title || company?.name || 'Terms & Conditions';
        ...
        <Card sx={{ p: 4 }}>
          <Stack spacing={4}>
            ...
            <Typography variant="body1" color="text.secondary">
              These terms and conditions govern your use of our whistleblower reporting system. By
