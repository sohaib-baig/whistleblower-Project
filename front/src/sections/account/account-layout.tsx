...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    href: `${paths.dashboard.user.profile}/change-password`,
  },
  {
    label: '2FA',
    icon: <Iconify width={24} icon="mdi:two-factor-authentication" />,
    href: `${paths.dashboard.user.profile}/two-factor`,
  },
  {
    label: 'Invoice',
    icon: <Iconify width={24} icon="ic:baseline-receipt-long" />,
    href: `${paths.dashboard.user.profile}/invoice`,
  },
];
