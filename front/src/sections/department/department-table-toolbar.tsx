import type { IDepartmentTableFilters } from 'src/types/department';
...
function DepartmentTableToolbarComponent({ filters, onFilters, statusOptions }: Props) {
  ...
  return (
    ...
    >
      <TextField
        ...
        placeholder={t('dashboard.department.search.placeholder')}
        InputProps={{
          startAdornment: (
...
export const DepartmentTableToolbar = memo(DepartmentTableToolbarComponent);
