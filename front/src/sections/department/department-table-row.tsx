...
export function DepartmentTableRow({ row, selected, editHref, onSelectRow, onDeleteRow, onEdit }: Props) {
      ...
      <MenuList>
        <li>
          ...
          >
            ...
            {t('dashboard.department.menu.edit')}
          </MenuItem>
        </li>
        ...
        >
          ...
          {t('dashboard.department.menu.delete')}
        </MenuItem>
      </MenuList>
    </CustomPopover>
  );
  ...
  const renderConfirmDialog = () => (
    <ConfirmDialog
      ...
      content={t('dashboard.department.confirmDialog.deleteConfirm')}
      action={
