...
export function InvoicePDFDownload({ invoice, currentStatus }: InvoicePDFProps) {
  ...
  return (
    ...
    >
      {({ loading }: { loading: boolean }) => renderButton(loading)}
    </PDFDownloadLink>
  );
}
  ...
  const renderBillingInfo = () => (
    <View style={[styles.container, styles.mb40]}>
      <View style={{ width: '50%' }}>
        ...
        {invoiceFrom?.company && (
          <Text style={[styles.text2]}>{invoiceFrom.company}</Text>
        )}
        {invoiceFrom?.companyNumber && (
          <Text style={[styles.text2]}>Company Number: {invoiceFrom.companyNumber}</Text>
        )}
      ...
      <View style={{ width: '50%' }}>
        ...
        {invoiceTo?.companyNumber && (
          <Text style={[styles.text2]}>Company Number: {invoiceTo.companyNumber}</Text>
        )}
