 ...
 * };
 *
 * const ex1 = getNestedProperty(data, 'calories'); // output: 360
 *
 * const ex2 = getNestedProperty(data, 'align'); // output: center
 *
 * const ex3 = getNestedProperty(data, 'more.protein'); // output: 42
 */
